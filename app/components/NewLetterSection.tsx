...
export const NewLetterSection: React.FC = () => {
    ...
    return (
        <div className="border-b-2 border-appWhite bg-appLightBlack h-auto p-2 flex flex-shrink overflow-hidden text-appWhite">
            <div className="mx-auto max-w-full lg:py-8 sm:px-2 py-10 lg:px-4 h-auto ">
                <div className="mt-0 grid grid-cols-1 gap-x-16 gap-y-5 lg:grid-cols-3 px-7">

                    <div className="mx-0 flex mt-0">
                        <div className="items-center justify-center flex sm:flex-shrink-0">
                            <Image
                                src={logo}
                    ...
                    <div className="sm:flex lg:block block">
                        ...
                        <div className="sm:flex items-center justify-evenly mt-4 xl:mt-10 lg:mt-10 xl:pb-0 lg:pb-0 pb-4">
                                ...
                                <form onSubmit={handleSubmit} className='w-full lg:flex items-center justify-center gap-3'>
                                    <div className='lg:flex flex-grow w-full'>
                                        ...
                                        <div>
                                            <button
                                                type='submit'
                                                className="focus:outline-none hover:bg-appTitleBgColor text-base font-medium leading-none text-white py-4 px-6 bg-appNav sm:ml-2 sm:w-auto w-full mt-2 xl:mt-0 lg:mt-0">SUBSCRIBE</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div className="sm:flex lg:block items-center justify-evenly pb-3 ">
                        ...
                        <div className="sm:flex-shrink-0 flex mt-3 items-center justify-center ">
                            <div className='md:flex justify-between gap-x-3 gap-y-6 md:justify-evenly w-full '>
                                <Link href={'/'} className='download-app-button'>
                                    <div className='mr-2'>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill='white' height="3em" viewBox="0 0 384 512"><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z" /></svg>
                                    </div>
                                    <div className='flex items-center md:block md:flex-none gap-x-2'>
                                        <span className='font-medium  tracking-normal'> Download on</span>
                                        <p className="text-base mt-0 font-bold">APP STORE</p>
                                    </div>
                                </Link>
                                <Link href={'/'} className='download-app-button'>
                                    <div className='md:mr-2'>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill='#fff' height="2.8em" viewBox="0 0 512 512"><path d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z" /></svg>
                                    </div>
                                    <div className='flex items-center md:block md:flex-none gap-x-2'>
                                        <span className='font-medium  tracking-normal'> Download on</span>
